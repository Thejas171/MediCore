...
MediCore follows the Spring Boot Layered MVC Architecture, also known as the N-Tier Architecture, ensuring clean separation of concerns, scalability, and easy maintenance.
...
Ensures controllers remain clean and lightweight
